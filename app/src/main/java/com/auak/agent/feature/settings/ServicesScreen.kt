...
import com.auak.agent.feature.terminal.TerminalViewModel
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            OverlayControlCard(
                ...
                onStartOverlay = { AuakClawOverlayService.start(context) },
                onStopOverlay = { AuakClawOverlayService.stop(context) }
            )
            ...
            if (showNeedConfigHint) {
                ...
                OutlinedCard(
                    ...
                    Column(modifier = Modifier.padding(12.dp)) {
                        ...
                        Spacer(Modifier.height(4.dp))
                        Text(
                            "Gateway 已启动，但需要配置 AI 模型才能使用。请打开 Web 控制台进行配置，或登录Agenty平台自动获取 AI 能力。",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                        Spacer(Modifier.height(8.dp))
