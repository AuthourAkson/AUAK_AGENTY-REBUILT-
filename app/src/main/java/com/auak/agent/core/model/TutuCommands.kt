package com.auak.agent.core.model
...
object agentyCommands {
    ...
    data class CommandCategory(
        @param:StringRes val nameResId: Int,
        val commands: List<agentyCommandSpec>
    )

    // region 1. Input Control
    private fun inputControl() = CommandCategory(R.string.cat_input_control, listOf(
        agentyCommandSpec(R.string.subcat_input_control, R.string.cmd_touch, "touch", listOf(
        ...
        agentyCommandSpec(R.string.subcat_input_control, R.string.cmd_key, "key", listOf(
        ...
        agentyCommandSpec(R.string.subcat_input_control, R.string.cmd_text, "text", listOf(
            ParamSpec("text", R.string.param_text_content, ParamType.STRING, true, "Hello"),
        ), hasResponse = false, needsDelay = true),
        agentyCommandSpec(R.string.subcat_input_control, R.string.cmd_scroll, "scroll", listOf(
        ...
        agentyCommandSpec(R.string.subcat_input_control, R.string.cmd_command, "command", listOf(
            ParamSpec("cmd", R.string.param_cmd, ParamType.STRING, true, "HOME"),
        ), hasResponse = false, needsDelay = true),
        agentyCommandSpec(R.string.subcat_input_control, R.string.cmd_start_app, "start_app", listOf(
    ...
    private fun systemCommands() = CommandCategory(R.string.cat_system_commands, listOf(
        agentyCommandSpec(R.string.subcat_system_commands, R.string.cmd_set_clipboard, "set_clipboard", listOf(
        ...
        agentyCommandSpec(R.string.subcat_system_commands, R.string.cmd_get_clipboard, "get_clipboard", hasResponse = false),
        agentyCommandSpec(R.string.subcat_system_commands, R.string.cmd_set_display_power, "set_display_power", listOf(
    ...
    private fun screenshotAndVideo() = CommandCategory(R.string.cat_screenshot_video, listOf(
        agentyCommandSpec(R.string.subcat_screenshot_video, R.string.cmd_screenshot, "screenshot", listOf(
        ...
        agentyCommandSpec(R.string.subcat_screenshot_video, R.string.cmd_start_video, "start_video", listOf(
        ...
        agentyCommandSpec(R.string.subcat_screenshot_video, R.string.cmd_stop_video, "stop_video"),
    ))
    // endregion

    // region 4. UI Automation
    private fun uiAutomation() = CommandCategory(R.string.cat_ui_automation, listOf(
        agentyCommandSpec(R.string.subcat_ui_automation, R.string.cmd_click_by_text, "click_by_text", listOf(
        ...
        agentyCommandSpec(R.string.subcat_ui_automation, R.string.cmd_click_by_id, "click_by_id", listOf(
            ParamSpec("id", R.string.param_resource_id, ParamType.STRING, true, "com.example:id/btn"),
            ParamSpec("index", R.string.param_index, ParamType.INT, false, "0"),
        ), needsDelay = true),
        agentyCommandSpec(R.string.subcat_ui_automation, R.string.cmd_find_element, "find_element", listOf(
        ...
        agentyCommandSpec(R.string.subcat_ui_automation, R.string.cmd_long_click, "long_click", listOf(
            ParamSpec("x", R.string.param_x, ParamType.INT, true, "500"),
            ParamSpec("y", R.string.param_y, ParamType.INT, true, "800"),
            ParamSpec("durationMs", R.string.param_duration_ms, ParamType.INT, false, "800"),
        ), needsDelay = true),
        agentyCommandSpec(R.string.subcat_ui_automation, R.string.cmd_swipe, "swipe", listOf(
        ...
        agentyCommandSpec(R.string.subcat_ui_automation, R.string.cmd_input_keyevent, "input_keyevent", listOf(
    ...
    private fun shellCommands() = CommandCategory(R.string.cat_shell_file, listOf(
        agentyCommandSpec(R.string.subcat_shell_file, R.string.cmd_execute_shell, "execute_shell", listOf(
    ...
    private fun appManagement() = CommandCategory(R.string.cat_app_management, listOf(
        agentyCommandSpec(R.string.subcat_app_management, R.string.cmd_list_packages, "list_packages", listOf(
        ...
        agentyCommandSpec(R.string.subcat_app_management, R.string.cmd_get_app_info, "get_app_info", listOf(
            ParamSpec("package", R.string.param_package, ParamType.STRING, true, "com.android.settings"),
        )),
        agentyCommandSpec(R.string.subcat_app_management, R.string.cmd_force_stop_app, "force_stop_app", listOf(
            ParamSpec("package", R.string.param_package, ParamType.STRING, true, "com.example.app"),
        )),
        agentyCommandSpec(R.string.subcat_app_management, R.string.cmd_uninstall_app, "uninstall_app", listOf(
            ParamSpec("package", R.string.param_package, ParamType.STRING, true, "com.example.app"),
            ParamSpec("keepData", R.string.param_keep_data, ParamType.BOOLEAN, false, "false"),
        )),
        agentyCommandSpec(R.string.subcat_app_management, R.string.cmd_install_apk, "install_apk", listOf(
            ParamSpec("path", R.string.param_apk_path, ParamType.STRING, true, "/sdcard/app.apk"),
        )),
        agentyCommandSpec(R.string.subcat_app_management, R.string.cmd_clear_app_data, "clear_app_data", listOf(
            ParamSpec("package", R.string.param_package, ParamType.STRING, true, "com.example.app"),
        )),
    ))
    // endregion
    ...
    private fun communicationAndMedia() = CommandCategory(R.string.cat_communication_media, listOf(
        agentyCommandSpec(R.string.subcat_communication_media, R.string.cmd_send_sms, "send_sms", listOf(
        ...
        agentyCommandSpec(R.string.subcat_communication_media, R.string.cmd_read_sms, "read_sms", listOf(
        ...
        agentyCommandSpec(R.string.subcat_communication_media, R.string.cmd_make_call, "make_call", listOf(
            ParamSpec("number", R.string.param_phone_number, ParamType.STRING, true, "13800138000"),
        )),
        agentyCommandSpec(R.string.subcat_communication_media, R.string.cmd_end_call, "end_call"),
    ))
    // endregion

    // region 7. Device Info
    private fun deviceInfo() = CommandCategory(R.string.cat_system_info, listOf(
        agentyCommandSpec(R.string.subcat_system_info, R.string.cmd_get_server_info, "get_server_info"),
        agentyCommandSpec(R.string.subcat_system_info, R.string.cmd_get_device_info, "get_device_info", hasResponse = false),
    ))
    // endregion

    // region 8. Service Control
    private fun serviceControl() = CommandCategory(R.string.cat_service_control, listOf(
        agentyCommandSpec(R.string.subcat_service_control, R.string.cmd_get_ui_nodes, "get_ui_nodes", listOf(
            ParamSpec("mode", R.string.param_ui_nodes_mode, ParamType.INT, false, "2"),
        ), hasResponse = false),
        agentyCommandSpec(R.string.subcat_service_control, R.string.cmd_shutdown, "shutdown"),
    ))
    // endregion

    fun buildJsonForCommand(
        spec: agentyCommandSpec,
