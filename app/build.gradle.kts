...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "agenty_APP_ID", "\"${secret("agenty_APP_ID")}\"")
        buildConfigField("String", "agenty_APP_SECRET", "\"${secret("agenty_APP_SECRET")}\"")
