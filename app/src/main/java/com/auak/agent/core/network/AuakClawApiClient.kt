package com.auak.agent.core.network

import com.auak.agent.core.model.AuakClawSkillDetail
import com.auak.agent.core.model.AuakClawSkillDetailResponse
...
class auak agentyApiClient {

    companion object {
        private const val BASE_URL = "https://agentyai.me"
    ...
    suspend fun fetchSkillList(
        ...
        page: Int = 1,
        limit: Int = 12
    ): Result<AuakClawSkillListResponse> = withContext(Dispatchers.IO) {
        try {
            ...
            val response = json.decodeFromString<AuakClawSkillListResponse>(body)
            if (response.success) {
    ...
    suspend fun fetchSkillDetail(slug: String): Result<AuakClawSkillDetail> =
        withContext(Dispatchers.IO) {
            try {
                ...
                val response = json.decodeFromString<AuakClawSkillDetailResponse>(body)
