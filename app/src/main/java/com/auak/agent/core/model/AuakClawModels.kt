...
@Serializable
data class AuakClawSkillListResponse(
    val success: Boolean,
    val list: List<AuakClawSkillItem> = emptyList(),
    val total: Int = 0,
    val page: Int = 1,
    val limit: Int = 12,
...
@Serializable
data class AuakClawSkillDetailResponse(
    val success: Boolean,
    val data: AuakClawSkillDetail? = null,
    val message: String? = null
)

@Serializable
data class AuakClawSkillDetail(
    val id: Int = 0,
    val slug: String = "",
    @SerialName("display_name") val displayName: String = "",
    @SerialName("display_name_en") val displayNameEn: String = "",
