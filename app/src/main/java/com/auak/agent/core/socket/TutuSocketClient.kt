package com.auak.agent.core.socket
...
class agentySocketClient(
    ...
    private val ctx get() = AuakClawApp.instance
    ...
    fun nextReqId(): String = "AuakClaw-${reqIdCounter.incrementAndGet()}"
    ...
    companion object {
        private const val TAG = "agentySocketClient"
