---
title: "AuakClaw Workspace"
summary: "AuakClaw workspace configuration and operational guide"
---
...
通过 `auak agenty-device` Skill（详见 `skills/auak agenty-device/SKILL.md`），你可以：
