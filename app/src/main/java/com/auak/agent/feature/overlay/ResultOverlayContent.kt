...
import com.auak.agent.ui.theme.AuakClawGold
import com.auak.agent.ui.theme.AuakClawGreen
import com.auak.agent.ui.theme.AuakClawRed
...
fun ResultOverlayContent(
    ...
    val statusColor = when {
        isSuccess -> AuakClawGreen
        isAborted -> AuakClawGold
        else -> AuakClawRed
    }
    val statusText = when {
        isSuccess -> "执行完成"
            ...
            Column(
                ...
                if (!result.errorMessage.isNullOrEmpty() && !isSuccess) {
                    ...
                    Text(
                        ...
                        color = AuakClawRed.copy(alpha = 0.9f),
                        fontSize = 11.sp,
                        maxLines = 3,
                        overflow = TextOverflow.Ellipsis
                    )
